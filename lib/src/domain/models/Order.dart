...
class Order {
    ...
    List<Map<String, dynamic>>? productsToCreate;
  ...
  factory Order.fromJson(Map<String, dynamic> json) {
      ...
      return Order(
        id: json["id"],
        idClient: json["id_user"] ?? json["user"]?["id"] ?? 0, // Usar id_user o sacar del objeto user
        idAddress: json["id_address"] ?? json["address"]?["id"] ?? 0, // Usar id_address o sacar del objeto address
        status: json["status"],
