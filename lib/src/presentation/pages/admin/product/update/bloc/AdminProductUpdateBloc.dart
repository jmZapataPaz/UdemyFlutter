...
class AdminProductUpdateBloc extends Bloc<AdminProductUpdateEvent, AdminProductUpdateState> {
  ...
  AdminProductUpdateBloc(this.productUseCase) : super(const AdminProductUpdateState()) {
    on<AdminProductUpdateInitEvent>(_onInit);
  ...
  Future<void> _onInit(AdminProductUpdateInitEvent event, Emitter<AdminProductUpdateState> emit) async{
    emit(state.copyWith(
      id: event.product?.id,
      id_category: event.product?.id_category ,
  ...
  Future<void> _onFormSubmit(FormSubmit event, Emitter<AdminProductUpdateState> emit) async{
    ...
    Resource response = await productUseCase.updateProductUseCase.run(
